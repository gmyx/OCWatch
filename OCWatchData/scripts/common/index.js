...
module.exports = {
    ...
    realtime: {
        getRunname: function () {
            let options = [{year: 'numeric'}, {month: 'short'}, {day: 'numeric'}, {hour: 'numeric', hour12: false}, {minute: 'numeric'}, {second: 'numeric'}];
            let joined = join(new Date, options, '-');
